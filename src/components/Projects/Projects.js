...
import dataAnalysis from "../../../public/Assests/Projects/dataAnalysis.jpg";
import dataMinning from "../../../public/Assests/Projects/processMinning.jpg";
import simulation from "../../../public/Assests/Projects/simulation.jpg";
import need_assessment from "../../../public/Assests/Projects/needs_assessment.jpg";
import market_research from "../../../public/Assests/Projects/market_research.jpg";
import scheduling from "../../../public/Assests/Projects/scheduling.jpg";
import {
    ProjectContainer,
    Main,
    Heading,
                        ...
                        <Content>
                            <RightDiv>
                                ...
                                <Link href={current_path + "/needs-assessment" + `?lang=${language}`} >
                                    <Container>
                                        <Image image={need_assessment.src} >
                                            <div className="layer" />
                                        </Image>
                                        <RightText>
                                            نیازسنجی
                                ...
                                <Link href={current_path + "/market-research" + `?lang=${language}`} >
                                    <Container>
                                        ...
                                        <Image image={market_research.src} >
                                            <div className="layer" />
                                        </Image>
                                    </Container>
                                </Link>
